...
<body>
 <?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql="INSERT INTO account(`student_id`, `semester_fee`, `late_fine`, `library_fine`, `semester_name`) VALUES ('$identity', '$semester_fee', '$late_fine', '$library_fine', '$semester_name')";
